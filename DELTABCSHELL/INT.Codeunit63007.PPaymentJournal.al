codeunit 63007 "P:Payment Journal"
{
    ...
    [EventSubscriber(ObjectType::Page, 256, 'OnBeforeActionEvent', "Post and &Print", false, false)]
    ...
    [EventSubscriber(ObjectType::Page, 256, 'OnAfterActionEvent', "Post and &Print", false, false)]
