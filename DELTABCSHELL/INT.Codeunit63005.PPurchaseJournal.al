codeunit 63005 "P:Purchase Journal"
{
    ...
    [EventSubscriber(ObjectType::Page, 254, 'OnBeforeActionEvent', "Post and &Print", false, false)]
    ...
    [EventSubscriber(ObjectType::Page, 254, 'OnAfterActionEvent', "Post and &Print", false, false)]
