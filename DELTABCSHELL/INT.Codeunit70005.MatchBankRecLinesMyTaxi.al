codeunit 70005 "Match Bank Rec. Lines MyTaxi"
{
    ...
    begin
        ...
        //BankAccReconciliationLine.SetRange(Type, BankAccReconciliationLine.Type::"Bank Account Ledger Entry");//SPS
        TotalCount := BankAccReconciliationLine.Count;

        BankAccReconciliationLine.SetFilter("Bal. Account Type", '<>%1', BankAccReconciliationLine."Bal. Account Type"::"G/L Account");
