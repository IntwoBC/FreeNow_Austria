codeunit 62000 "C:ApplicationManagement"
{
    ...
    begin
        ...
        case lrecEYCoreSetup."Company Type" of
    ...
    begin
        if (not lrecEYCoreSetup.Get) and lrecGLAccount.IsEmpty then begin
            ...
            with lrecSourceCodeSetup do
                if Get then begin
                    lfcnInsertSourceCode("TB Reversal", txt60000, txt60001);
                    lfcnInsertSourceCode("Import Tool", txt60002, txt60003);
                    lfcnInsertSourceCode("GAAP/Tax Reversal", txt60004, txt60005);
                    Modify(true);
                end;
