page 60022 "Tax Adjustment Journal"
{
    // MP 26-11-13
    // Fields "Corporate G/L Account No." and "Bal. Corporate G/L Account No." now not editable if Bottom-UP (CR 30)
    ...
    AutoSplitKey = true;
    Caption = 'Tax Adjustment Journal';
    ...
    begin
        ...
        BalanceVisible := true;
        gblnCorpAccInUse := lmdlCompanyTypeMgt.gfcnCorpAccInUse; // MP 28-04-14
    end;
    ...
    var
        ...
        JnlSelected: Boolean;
    begin
        gblnBottomUp := lmdlCompanyTypeMgt.gfcnIsBottomUp; // MP 26-11-13
        ...
        GenJnlManagement.TemplateSelection(PAGE::"Tax Adjustment Journal", 18, false, Rec, JnlSelected);
    ...
    begin
        if lrecGenJnlTemplate.Get(Rec.GetRangeMax(Rec."Journal Template Name")) then
