codeunit 63004 "P:Sales Journal"
{
    ...
    /*
        [EventSubscriber(ObjectType::Page, 253, 'OnAfterActionEvent', 'UnPostedBalance', false, false)]
    ...
    [EventSubscriber(ObjectType::Page, 253, 'OnBeforeActionEvent', 'Post', false, false)]
    ...
    [EventSubscriber(ObjectType::Page, 253, 'OnAfterActionEvent', 'Post', false, false)]
    local procedure levtOnAfterActionEventPost(var Rec: Record "Gen. Journal Line")
    begin
        Rec.SetRange("Ready to Post");
    end;

    [EventSubscriber(ObjectType::Page, 253, 'OnBeforeActionEvent', "Post and &Print", false, false)]
    ...
    [EventSubscriber(ObjectType::Page, 253, 'OnAfterActionEvent', "Post and &Print", false, false)]
    local procedure levtOnAfterActionEventPostAndPrint(var Rec: Record "Gen. Journal Line")
    begin
        Rec.SetRange("Ready to Post");
    end;

    [EventSubscriber(ObjectType::Page, 253, 'OnBeforeActionEvent', 'Preview', false, false)]
