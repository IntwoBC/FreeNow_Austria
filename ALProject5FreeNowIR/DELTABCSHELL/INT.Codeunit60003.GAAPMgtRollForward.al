codeunit 60003 "GAAP Mgt. - Roll Forward"
{
    ...
    begin
        with precCorpAccountingPeriod do begin
            ...
            SetRange("Starting Date", ldatFiscalYearStartDate, lrecCorpAccountingPeriod2."Starting Date");
            ModifyAll(Closed, true);

            SetRange("Starting Date", ldatFiscalYearStartDate, lrecCorpAccountingPeriod3."Starting Date");
