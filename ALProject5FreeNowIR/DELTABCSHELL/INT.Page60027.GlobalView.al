page 60027 "Global View"
{
    ...
    begin
        ...
        if lmdlCompanyTypeMgt.gfcnIsBottomUp then begin
            //lrecGenJnlTemplate.SetRange(Type, lrecGenJnlTemplate.Type::"Group Adjustments");//SPS
            lrecGenJnlTemplate.FindFirst;
            gcodGroupDimCode := lrecGenJnlTemplate."Shortcut Dimension 1 Code";
        end else begin
            // MP 25-11-13 <<
            //lrecGenJnlTemplate.SetRange(Type, lrecGenJnlTemplate.Type::"GAAP Adjustments");//SPS
            lrecGenJnlTemplate.FindFirst;
            gcodStatDimCode := lrecGenJnlTemplate."Shortcut Dimension 1 Code";
        end; // MP 25-11-13

        //lrecGenJnlTemplate.SetRange(Type, lrecGenJnlTemplate.Type::"Tax Adjustments");//SPS
        lrecGenJnlTemplate.FindFirst;
