codeunit 60025 "Toggle Mark GAAP/Tax Reversal"
{
    ...
    begin
        ...
        Rec.TestField("Reversed at", 0D);

        if not Confirm(StrSubstNo(txtConfirmToggleReversal, Rec.FieldCaption("Document No."), Rec."Document No.",
          Rec.FieldCaption("Posting Date"), Rec."Posting Date"))
        then
            exit;
        ...
        repeat
            ...
            lrecGLEntry.Validate(Reversible, Rec.Reversible);
            lrecGLEntry.Modify;
