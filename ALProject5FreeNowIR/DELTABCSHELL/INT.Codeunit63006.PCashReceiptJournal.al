codeunit 63006 "P:Cash Receipt Journal"
{
    ...
    [EventSubscriber(ObjectType::Page, 255, 'OnBeforeActionEvent', "Post and &Print", false, false)]
    ...
    [EventSubscriber(ObjectType::Page, 255, 'OnAfterActionEvent', "Post and &Print", false, false)]
